...
opts.onLoadSuccess.call(_33c,data);//dxq
_345(_33c);
};
...
var rows=data.rows;
$.data(_43e,"datagrid").data=data;//dxq
if(data.footer){
...
var rows=$.data(_446,"datagrid").data.rows; //dxq
...
var data=$.data(_461,"datagrid").data;//dxq
if(opts.idField){
var _463=-1;
...
opts.onLoadSuccess.call(_6c1,data);//dxq
