...
<body>
	<div id="head">
	<div class="weizhi">你的位置是：数据管理 >> 用户管理 >> 批量导入</div>
		<table class="biaoge_1" style="margin-top:10px;">
			<tr>
				<td class="biaoge_11">下载模板</td>
				<td class="biaoge_12"><input type="button" class="button_1" name="" value="下载模板" onclick="base.downloadTemplate('${ctx }/static/template/user_template.xls','用户导入模板.xls');"/></td>
			</tr>
			<tr>
